        ...
        {isLoggedIn && (
          <div className="relative z-50" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-3 rounded-full border border-slate-200 bg-white px-3 py-2 text-slate-700 hover:bg-slate-50 hover:text-blue-700 transition"
            >
              <div className="h-10 w-10 rounded-full overflow-hidden bg-blue-100 flex items-center justify-center shrink-0">
                {profilePhoto ? (
                  <img
                    src={profilePhoto}
                    alt="Foto de perfil"
              ...
              <span className="hidden sm:inline font-semibold text-sm max-w-[180px] truncate">
                {displayName}
              </span>
            ...
            {menuOpen && (
              <div className="absolute right-0 top-full mt-2 z-50 w-60 rounded-2xl border border-slate-200 bg-white shadow-lg overflow-hidden">
                <Link
                  to={perfilPath}
      ...
      <div className="relative w-full h-16 flex items-center px-4">
        ...
        {isLoggedIn ? (
          ...
          <div className="ml-auto hidden md:flex items-center gap-3">
            <Link
              to="/auth/login"
              className="inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-5 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
            >
              Iniciar sesión
            </Link>
            ...
            <Link
              to="/auth/register"
              className="inline-flex items-center justify-center rounded-full bg-blue-700 px-5 py-2 text-sm font-medium text-white transition hover:bg-blue-800"
            >
              Registrarse
            </Link>
          </div>
