    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AppLayout />}>
          <Route path="/app" element={
            <Navigate to={localStorage.getItem("rol") === "comisionista" ? "/comisionista/dashboard" : "/cliente/dashboard"} replace />
          } />
      ...
      <Route element={<ProtectedRoute allowedRoles={["comisionista"]} />}>
        <Route element={<ComisionistaLayout />}>
          ...
          {/* ✅ Ambas rutas apuntan al mismo componente */}
