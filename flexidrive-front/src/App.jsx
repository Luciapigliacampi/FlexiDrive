      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={["cliente"]} />}>
          <Route element={<ClienteLayout />}>
            ...
            <Route
              path="/cliente/seleccionar-comisionista"
              element={<SeleccionComisionista />}
            />
            ...
            <Route
              path="/cliente/destinatarios"
              element={<DestinatariosFrecuentes />}
            />
            <Route path="/cliente/soporte" element={<AyudaSoporte />} />
            <Route
              path="/cliente/confirmacion-envio"
              element={<ConfirmacionEnvio />}
            />
            <Route path="/cliente/pago" element={<PagoEnvio />} />
            <Route
              path="/cliente/envios/:id/calificar"
              element={<CalificarComisionista />}
            />
        ...
        <Route element={<ProtectedRoute allowedRoles={["comisionista"]} />}>
          <Route element={<ComisionistaLayout />}>
            ...
            <Route
              path="/comisionista/envios/:id"
              element={<TrackingEnvioComisionista />}
            />
            <Route
              path="/comisionista/envios/:id/tracking"
              element={<TrackingEnvioComisionista />}
            />
            <Route
              path="/comisionista/notificaciones"
              element={<NotificacionesComisionista />}
            />
          </Route>
        </Route>
