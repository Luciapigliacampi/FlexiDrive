        ...
        <form onSubmit={submit} className="p-5 space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-md border bg-white hover:bg-slate-50 font-bold"
            >
              Cancelar
            </button>
            <button
              type="submit"
              className="px-4 py-2 rounded-md bg-blue-700 text-white font-bold hover:bg-blue-800"
            >
              Guardar
            </button>
          </div>
