...
function getStepKey(estado, data) {
  ...
  const esRetorno = estadoNormalizado === "CANCELADO_RETORNO" || data?.es_retorno;

  if (esCancelado) return null;

  if (esRetorno) return "en_camino";

  if (esDemorado) {
    return estadoNormalizado === "DEMORADO_RETIRO" ? "en_retiro" : "en_camino";
  }
...
const isDemorado = 
    ...
    data.es_demorado;
  const esRetorno = estado === "CANCELADO_RETORNO" || data.es_retorno;
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="relative" ref={actionsRef}>
          <button
            ...
            className={[
              "h-10 w-10 transition flex items-center justify-center hover:bg-slate-50",
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {isCancelado ? (
            <div className="rounded-2xl border border-slate-200 bg-white p-5">
              <div className="text-sm font-semibold uppercase tracking-wide text-slate-500 mb-3">
                Progreso del envío
              </div>
